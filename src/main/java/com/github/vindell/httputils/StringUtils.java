...
public abstract class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static boolean getSafeBoolean(Object str, String defaultStr) {
		return BooleanUtils.toBoolean(getSafeStr(str , defaultStr));
	}
	 ...
	 * @return int[宽,高]
	 */
	public static int[] getStringWidthAndHeigth(String str) {
	 ...
	 * @author 		： <a href="https://github.com/vindell">vindell</a>
	 * @date 		：2017年9月12日 下午10:44:36
	 * @param str
	 * @param code
	 * @return
	 */
	public static int getStringLengthCode(String str, String code) {
		int length = 0;
		try {
			// 根据编码格式获得字符长度
